...
import TopImage from "../components/legacy/TopImage";
import TopText from "../components/legacy/TopText";
import Bottom from "../components/legacy/Bottom";
...
const Legacy = () => {
    ...
    return (
        <div ref={parentRef} className="parent">
            ...
            >
                <ScrollVelocity texts={['    Built By Time    ', '    ENGINEERED FOREVER    ']} />
            </div>
